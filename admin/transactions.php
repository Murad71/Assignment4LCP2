...
foreach ($transactionsData as $email => $transactions) {
    foreach ($transactions as $transaction) {
        $transaction['customer_name'] = isset($emailToNameMap[$email]) ? $emailToNameMap[$email] : 'Unknown';
        $flattenedTransactions[] = $transaction;
    }
}


usort($flattenedTransactions, function ($a, $b) {
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  ...
                  <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        <?php foreach ($flattenedTransactions as $transaction): ?>
                          <tr>
                            <td
                            ...
                            <td
                              class="whitespace-nowrap px-2 py-4 text-sm font-medium <?php echo isset($transaction['from']) ? 'text-red-600' : 'text-emerald-600'; ?>"
                            >
                              <?php echo (isset($transaction['from']) ? '-' : '+') . '$' . number_format($transaction['amount'], 2); ?>
                            </td>
                            <td
